...
/**
 * Contains stubs for botballsim. Botballsim DOES NOT SUPPORT the camera
...
public class SimulatedCamera extends Camera {
	...
	public SimulatedCamera(BotballProgram bp) {}
	...
	/**
	 * Determine if tracking data is available which is newer than the data
	 * processed by the last call to <code>track_update()</code>.
	 *
	 * @return Some value other than 0 if true (probably 1), 0 if false
	 */
	public int track_is_new_data_available() { return 0; }
	
	
	
	/**
	 * Process tracking data for a new frame and make it available for retrieval
	...
	/**
	 * Use to return value is the frame number used to generate the tracking
	 * data.
	 *
	 ...
	 */
	public int track_get_frame() { return 0; }
	
	
	
	/**
	 * Use to return the number of blobs available for the channel ch, which is
	 * a color channel numbered 0 through 3.
	 * 
	 * @param  ch  from channel (range 0-3)
	 * @see        #track_init
	 * @see        #track_update
	 */
	public int track_count(int ch) { return 0; }
	 ...
	 */
	public int track_size(int ch, int i) { return 0; }
	 ...
	 * @see        #track_angle
	 */
	public int track_x(int ch, int i) { return 0; }
	 ...
	 * @see        #track_x
	 */
	public int track_y(int ch, int i) { return 0; }
	
	
	
	/**
	 * Gets the confidence for seeing the blob as a percentage of the blob pixel
	 * area/bounding box area
	 * 
	 * @param  ch  from channel (range 0-3)
	 * @param  i   index (range 0 to track_count(ch)-1)
	 * @return     The confidence for seeing the blob as a percentage of the
	 * blob pixel area/bounding box area (range 0-100, low numbers bad, high
	 * numbers good)
	 * @see        #track_init
	 * @see        #track_update
	 */
	public int track_confidence(int ch, int i) { return 0; }
	 ...
	 * @see        #track_update
	 */
	public int track_bbox_left(int ch, int i) { return 0; }
	 ...
	 * @see        #track_update
	 */
	public int track_bbox_right(int ch, int i) { return 0; }
	 ...
	 * @see        #track_update
	 */
	public int track_bbox_top(int ch, int i) { return 0; }
	 ...
	 * @see        #track_update
	 */
	public int track_bbox_bottom(int ch, int i) { return 0; }
	
	
	
	/**
	 * Gets the pixel x width of the bounding box of the blob. This is
	 * equivalent to track_bbox_right - track_bbox_left + 1
	 * 
	 * @param  ch  from channel (range 0-3)
	 * @param  i   index (range 0 to track_count(ch)-1)
	 * @return     The pixel x width of the bounding box of the blob. This is
	 *                 equivalent to track_bbox_right - track_bbox_left + 1
	 * @see        #track_init
	 * @see        #track_update
	 */
	public int track_bbox_width(int ch, int i) { return 0; }
	
	
	
	/**
	 * Gets the pixel y height of the bounding box of the blob. This is
	 * equivalent to track_bbox_bottom - track_bbox_top + 1
	 * 
	 * @param  ch  from channel (range 0-3)
	 * @param  i   index (range 0 to track_count(ch)-1)
	 ...
	 * @see        #track_update
	 */
	public int track_bbox_height(int ch, int i) { return 0; }
	
	
	
	/**
	 * Gets the angle in radians of the major axis of the blob.<p>
	 * Zero is horizontal and when the left end is higher than the right end the
	 * angle will be positive.<p>
	 * The range is -PI/2 to +PI/2.<p>
	 * If you don't know about eclipses you might start
	 * <a href="http://mathworld.wolfram.com/Ellipse.html">here</a> or ask your
	 * local math teacher about major and minor axes.
	 * 
	 * @param  ch  from channel (range 0-3)
	 * @param  i   index (range 0 to track_count(ch)-1)
	 ...
	 * @see        #track_update
	 */
	public float track_angle(int ch, int i) { return 0.0f; }
	 ...
	 * @param  ch  from channel (range 0-3)
	 * @param  i   index (range 0 to track_count(ch)-1)
	 * @return     The length in pixels of the major and minor axes of the
	 *                 bounding ellipse
	 * @see        #track_init
	 * @see        #track_update
	 */
	public int track_major_axis(int ch, int i) { return 0; }
	 ...
	 * @see        #track_update
	 */
	public int track_minor_axis(int ch, int i) { return 0; }
	 ...
	 */
	public int track_capture_time() { return 0; }
	 ...
	 * @see           #track_capture_time
	 */
	public int track_previous_capture_time() { return 0; }
